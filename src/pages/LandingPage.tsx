    ...
    <div className="flex flex-col min-h-screen">
      ...
      >
        <div className="container mx-auto px-4 text-center">
          ...
          >
            <button className="px-8 py-3 bg-[#557e35] text-white font-medium rounded-lg shadow-md hover:bg-[#4a6e2e] transition-all duration-300 transform hover:scale-105 min-w-[180px]">
              Ver Productos
            </button>
